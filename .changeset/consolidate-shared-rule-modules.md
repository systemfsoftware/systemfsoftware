...
No user-facing change; each published bundle was rebuilt from consolidated internal sources after the workspace-wide package restructure. Nothing to do on upgrade.
