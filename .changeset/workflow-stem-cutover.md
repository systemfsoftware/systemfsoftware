...
Workflow decision modules moved within their packages and a few decision functions dropped a wrapper that always succeeded. Exports, types, and behavior are unchanged for every consumer.
