...
Republished alongside the export-condition change in the packages these depend on. Nothing a consumer can observe moved: the exported names, the declarations, and the behaviour are identical.
