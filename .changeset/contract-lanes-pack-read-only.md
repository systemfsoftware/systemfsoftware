...
No shipped change. The contract lanes now pack the already-built tree without lifecycle scripts; this fixture touch re-hashes the build task while sources and published artifacts stay identical.
