...
Nothing changes for a consumer of these packages. The release pipeline
rebuilds them against the new wire schema release; their own exported
surfaces, types, and runtime behaviour are identical.
