...
Repo layout only: the oxlint config presets moved from packages/oxlint-plugin/ to packages/oxlint-presets/. No rule, setting, or published entry point changes; these entries record the devDependency build-hash cascade.
