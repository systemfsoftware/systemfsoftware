...
export default {
  'code/**/*.{js,jsx,mjs,ts,tsx,html,json}': [fmtCmd],
  'code/**/*.{js,jsx,mjs,ts,tsx}': [`yarn --cwd code lint:js:cmd${lintSuffix}`],
  'scripts/**/*.{js,jsx,mjs,ts,tsx}': [`yarn --cwd scripts lint:js:cmd${lintSuffix}`],
