...
import type { DispatchDoctrineExtension as _DispatchDoctrineExtension } from '../src/dispatch-doctrine.handler.js'
import {
  BOTH_GUARDS_TOML,
  buildSession,
  createProjectDir,
  ...
  SESSION_A,
  SESSION_B,
} from './__fixtures__/dispatch-doctrine-fixture.observer.js'
