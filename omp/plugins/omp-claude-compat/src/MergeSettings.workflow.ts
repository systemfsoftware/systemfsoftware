...
import { BRIDGED_EVENTS, type BridgedEvent } from './HookCatalog.js'
import type { HookEntry, HookSettings } from './HookSettings.schema.js'
import { SettingsJSON } from './HookSettings.schema.js'

class SettingsDecisionImpossible extends S.TaggedError<SettingsDecisionImpossible>()(
  'SettingsDecisionImpossible',
  { reason: S.String },
) {}
export type SettingsDecisionError = InstanceType<typeof SettingsDecisionImpossible>
...
export const mergeEffectiveSettings = Workflow.make(
  ...
  (command): Result.Result<SettingsSnapshot, SettingsDecisionImpossible> =>
