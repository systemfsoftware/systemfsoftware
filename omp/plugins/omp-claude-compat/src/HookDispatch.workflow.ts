...
class AdmitImpossible extends S.TaggedError<AdmitImpossible>()('AdmitImpossible', {
  reason: S.String,
}) {}
...
export type AdmitError = InstanceType<typeof AdmitImpossible>
...
export const admitLoadedSettings = Workflow.make(
  AdmitHooksCommand,
  (command): Result.Result<HookDispatchDecision, AdmitImpossible> =>
