...
import type { HookDispatchResult } from '@systemfsoftware/omp-claude-compat/api'
import { onToolResult } from '@systemfsoftware/omp-claude-compat/api'
import { HookScopeLive } from '@systemfsoftware/omp-claude-compat/api'
import type { HookSession } from '@systemfsoftware/omp-claude-compat/api'
