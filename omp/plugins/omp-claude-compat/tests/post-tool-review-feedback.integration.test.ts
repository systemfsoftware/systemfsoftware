...
import type { HookDispatchResult } from '@systemfsoftware/omp-claude-compat'
import { onToolResult } from '@systemfsoftware/omp-claude-compat'
import { HookScopeLive } from '@systemfsoftware/omp-claude-compat'
import type { HookSession } from '@systemfsoftware/omp-claude-compat'
