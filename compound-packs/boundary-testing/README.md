...
- Shared law contract suites verifying store consistency, commutativity, and concurrency across in-memory fakes and production database adapters (`fake-and-real-store-laws`).
