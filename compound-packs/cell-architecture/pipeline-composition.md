...
tags: [cell, composition, combinators, and-then, do-notation]
---
...
- **`Cell.Do` / `Cell.bind` / `Cell.let`**: Accumulates intermediate values across multiple cells into a typed scope object while observing the same input.
