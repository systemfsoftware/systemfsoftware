...
import type { StockPosition, WarehouseStockPartition } from './inventory.schema.js'

export interface StockPageQuery {
  readonly cursor: Option.Option<StockPosition>
...
export interface InventoryStoreService {
  readonly readStockPage: (query: StockPageQuery) => Effect.Effect<StockPage, StoreUnavailable>
}
