    ...
    in
    {
      packages = forEachSystem (pkgs:
        let
          ...
          grit = pkgs.callPackage ./nix/grit.nix { };
        ...
        in { inherit dprint grit comment-checker-bwrap; comment-checker = cc; default = dprint; });
      ...
      devShells = forEachSystem (pkgs: {
        default = pkgs.mkShell {
          packages = [
            ...
            self.packages.${pkgs.stdenv.hostPlatform.system}.grit
