...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/`       | Workspace packages — see Package Index below                                                                                         | Root invariants plus a plugin-delivered leaf — gate: `omp plugin doctor` + `node omp/scripts/smoke-plugin.mjs omp/plugins/omp-leaf-context/dist/index.js` |
