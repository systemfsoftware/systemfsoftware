...
If your `package.json` contains a `types` or `typings` field, or its `exports` field contains a `types` entry, declaration file generation will be **enabled by default** in `tsdown`.
