...
| Angular (Vite)    | Your TypeScript sources, read on the Storybook server ([details](../get-started/frameworks/angular-vite.mdx#component-documentation)), or [compodoc](https://compodoc.app/) if you turn that off |
