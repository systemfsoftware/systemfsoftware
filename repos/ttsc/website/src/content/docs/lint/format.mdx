...
- Unbraced control-flow statements, including expressions in their headers and bodies. Their layouts remain intact so independently reflowed expressions cannot alternate between flat and broken forms. Calls inside a braced body still reflow, even beneath an outer unbraced statement.
