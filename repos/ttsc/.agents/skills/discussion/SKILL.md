---
name: discussion
description: Runs structured multi-agent discussions for open-ended ttsc topics. Use only when the user explicitly asks for Discussion or a team debate with transcripts and conclusions; do not use for Self-Review, Review Cycle, research review, or issue discovery.
---
