...
// Streaming generation for the hybrid KDA model: Model.inference
// rewrites the KDA layers into stateful recurrent decode — fixed-size
// per-sequence state, no positional encoding anywhere, and only the two
// NoPE attention layers keep a (sliding-window) KV cache. Usage:
