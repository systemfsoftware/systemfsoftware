...
import { checkPackage, ProblemKindSchema, withTypesCompanion } from '@systemfsoftware/arethetypeswrong'
          ...
          Given('the recipe package')('pkg', () =>
            Effect.sync(() => {
              ...
              if (recipeKey === 'TypesCompanion') {
                return withTypesCompanion(pkg, recipes.TypesCompanionTypes())
              }
              return pkg
            })),
