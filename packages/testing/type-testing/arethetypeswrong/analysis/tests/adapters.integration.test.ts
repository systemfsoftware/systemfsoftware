/* oxlint-disable @systemfsoftware/effect-dmmf/tests-import-public-api -- U6: private adapters are intentionally reached via relative source path; the barrel no longer re-exports them and the test must verify internal binding */
...
// oxlint-disable-next-line @systemfsoftware/oxlint-plugin-effect-dmmf/tests-import-public-api -- private adapters are package-internal; the barrel no longer re-exports them and the test must reach the source directly
