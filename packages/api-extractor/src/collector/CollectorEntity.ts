...
import { sortSet } from './sort.js'

import type { AstEntity } from '../analyzer/AstEntity.js'
import { AstNamespaceExport } from '../analyzer/AstNamespaceExport.js'
...
export class CollectorEntity extends Pipeable.Class {
   ...
   * such as "export class X extends Pipeable.Class { }" instead of "export { X }".
   */
