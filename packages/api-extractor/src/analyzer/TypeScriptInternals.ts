...
export class TypeScriptInternals extends Pipeable.Class {
   ...
   */
  public static getJSDocCommentRanges(_node: ts.Node, _text: string): ts.CommentRange[] | undefined {
    // Compiler internal:
  ...
  /*
   * In an statement like `export default class X extends Pipeable.Class { }`, the `Symbol.name` will be `default`
