...
import type { ApiItemMetadata as ApiItemMetadataBase } from '../collector/ApiItemMetadata.js'
...
export class AstDeclaration extends Pipeable.Class {
   ...
   */
  declare public declarationMetadata: DeclarationMetadataBase
   ...
   */
  declare public apiItemMetadata: ApiItemMetadataBase
  ...
  public constructor(options: IAstDeclarationOptions) {
    ...
    //
    //    class Person extends Pipeable.Class { #name: string; }
    //
