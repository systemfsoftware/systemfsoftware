...
export const meta = {
  ...
  docs: {
    description:
      'A locally-declared Effect Schema filter carries constructive-generation metadata: arbitrary.constraint or arbitrary.candidate (or a node toArbitrary override before the check). A filter without them generates by discarding.',
  },
  schema: [],
  messages: {
