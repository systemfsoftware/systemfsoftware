...
- id: KK1
  ...
  do: implement KE1 (purity) and KE2 (no domain imports) mechanically; leave KE3 (vocabulary), KE4 (dispatch), and KE5 (property tests) to review and mutation gates
...
- id: KK2
  ...
  dont: ban the effect barrel or effect/Effect imports — a kernel imports library primitives and builds Effect descriptions
