...
export const TAG_IDENTIFIER_MISMATCH_FIX = 'make the Context.Tag identifier string equal the class name' as const
...
export const meta = {
  ...
  docs: {
    description:
      'Enforce the consumer-owned <Executor>Deps Context.Tag in *.executor.ts files: exactly one, named after the file, with a matching identifier string.',
  },
  schema: [Options],
  messages: {
