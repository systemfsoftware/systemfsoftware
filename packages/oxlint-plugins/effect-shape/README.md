...
Only the mechanically-enforceable fragment of the cell skill is linted here. The reverse direction (no non-shape file imports a foreign constructor) stays review-gated — see the cell skill's SH1/SH5 and `AGENTS.md`.
