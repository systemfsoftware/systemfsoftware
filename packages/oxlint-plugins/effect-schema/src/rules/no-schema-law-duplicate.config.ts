...
export const LAW_DUPLICATE_EXPECTED =
  'only refusals in a *.schema.property.test.ts — a `refutes(schema, generators)` call from `@systemfsoftware/effect-schema-law` stating what the schema rejects' as const
