...
The kernel's behaviour suite lives in the private `packages/sim/effect-sim-kernel-tests` package, because the Gherkin runner it is written in runs on this kernel:
