...
export const AttwConfigSchema = Schema.Struct({
  ...
  quiet: Schema.optional(Schema.Boolean.pipe(Schema.brand('Quiet'))),
  summary: Schema.optional(Schema.Boolean.pipe(Schema.brand('Summary'))),
  emoji: Schema.optional(Schema.Boolean.pipe(Schema.brand('Emoji'))),
  color: Schema.optional(Schema.Boolean.pipe(Schema.brand('Color'))),
  ...
  entrypointsLegacy: Schema.optional(Schema.Boolean.pipe(Schema.brand('EntrypointsLegacy'))),
  fromNpm: Schema.optional(Schema.Boolean.pipe(Schema.brand('FromNpm'))),
  pack: Schema.optional(Schema.Boolean.pipe(Schema.brand('Pack'))),
