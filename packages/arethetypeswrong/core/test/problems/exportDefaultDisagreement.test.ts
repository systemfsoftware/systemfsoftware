...
import check from '../../src/internal/checks/exportDefaultDisagreement.ts'
import type { CheckExecutionContext } from '../../src/internal/defineCheck.ts'
import { getEntrypointInfo } from '../../src/internal/getEntrypointInfo.ts'
import { createCompilerHosts } from '../../src/internal/multiCompilerHost.ts'
