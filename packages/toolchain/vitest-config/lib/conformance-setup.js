 ...
 * only its own `@systemfsoftware/vitest` `afterEach` export, and this module is
 * runner infrastructure in a runner-driving package, not a test. The import
 * resolves to the same Vitest the worker is running under.
 *
