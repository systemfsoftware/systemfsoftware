...
<
  ...
  ER,
  RM extends RpcClient.Protocol | Rpc.MiddlewareClient<NoInfer<Rpcs>> | Rpc.Context<NoInfer<Rpcs>> | Scope =
    | RpcClient.Protocol
...
>(
  ...
  options: {
    ...
    readonly protocol: Layer.Layer<
      RpcClient.Protocol | Rpc.MiddlewareClient<NoInfer<Rpcs>> | Exclude<NoInfer<RM>, Scope>,
      ER
    >
