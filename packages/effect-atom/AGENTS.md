...
Vendored fork of [tim-smart/effect-atom](https://github.com/tim-smart/effect-atom) (MIT, "Effect contributors"), extracted from WireBlast's `packages/effect-atom` at its `HEAD` and rescoped under this org.
