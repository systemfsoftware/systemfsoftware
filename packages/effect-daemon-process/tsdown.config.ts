...
// the public surface is a namespace barrel (`export * as ProcessMedium`), which the
// rollup flattens into a value and breaks namespace-as-type consumers with TS2749.
