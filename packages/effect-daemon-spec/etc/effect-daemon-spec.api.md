...
//
// dist/index.d.ts:287:3 - (ae-forgotten-export) The symbol "dynamic$1" needs to be exported by the entry point index.d.ts
// dist/index.d.ts:296:3 - (ae-forgotten-export) The symbol "custom" needs to be exported by the entry point index.d.ts
