...
Shared conventions: `packages/oxlint-plugin/AGENTS.md`. One-shot bundle: a plain object spread over the surviving sources (property-testing, test-hygiene, test-placement, effect-schema, effect-workflow) plus a `recommendedFrom` helper. No rule logic of its own — see `README.md#development`.
