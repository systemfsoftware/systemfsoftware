...
export const NO_SUBJECT_IMPORT_ACTUAL =
  'a behaviour file whose every runtime import is vitest, @effect/vitest, @systemfsoftware/vitest, the gherkin spec package, effect, a Node builtin, or the file itself' as const
