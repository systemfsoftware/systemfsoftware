...
describe('aggregate registration contract', () => {
  it('Should_ExposeEveryLeafRule_When_TheAggregateSpreadsTheLeaves', () => {
  ...
  it('Should_RecommendEveryLeafRecommendation_When_TheAggregateDerivesRecommended', () => {
