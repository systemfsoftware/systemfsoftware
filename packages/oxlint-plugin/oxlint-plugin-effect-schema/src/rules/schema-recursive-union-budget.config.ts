...
export const FIX =
  'hoist the cycle to a single Schema.suspend at the recursion point, so the members reference the union schema directly, or declare the budget with terminatingRecursion from @systemfsoftware/effect-schema-extensions' as const
