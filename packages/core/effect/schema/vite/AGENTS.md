...
| ID          | Rule                                                                                                                                                                                                                                                                                                                                                               | Gate                                                                                                                                                                     |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **VITE-V1** | Consumers rely on the injected law tests for round-trip identity and encode stability of every exported schema — never hand-write `it.prop` cases re-asserting `decode∘encode` identity or `S.equivalence` roundtrips for a covered schema (hand-written property tests are for domain invariants).                                                                | `grep -rnE 'S\.equivalence' packages/core/effect/daemon-spec/src packages/core/hex/hex-schema/src packages/testing/mutation/plugins/stryker-plugins/src` returns nothing |
