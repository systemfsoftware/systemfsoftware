  ...
  scenario(
    ...
    Gherkin.Do.pipe(
      ...
      Then('the highest class wins')((s: { pending: Set<ExitClass> }) => {
        checkExpect(resolveExitCode(s.pending, null)).toBe(4)
      }),
    ),
  )
  ...
  scenario(
    ...
    Gherkin.Do.pipe(
      ...
      Then('the config error outranks the verdict failure')((s: { pending: Set<ExitClass> }) => {
        checkExpect(resolveExitCode(s.pending, null)).toBe(2)
      }),
    ),
  )
  ...
  scenario(
    ...
    Gherkin.Do.pipe(
      ...
      Then('the runtime error outranks the verdict failure')((s: { pending: Set<ExitClass> }) => {
        checkExpect(resolveExitCode(s.pending, null)).toBe(3)
      }),
    ),
  )
  ...
  scenario(
    ...
    Gherkin.Do.pipe(
      ...
      Then('the code is 130')((s: { signal: number }) => {
        checkExpect(resolveExitCode(new Set(), s.signal)).toBe(130)
      }),
    ),
  )
  ...
  scenario(
    ...
    Gherkin.Do.pipe(
      ...
      Then('the signal wins over every pending class')((s: {
        ...
        checkExpect(resolveExitCode(s.args.pending, s.args.signal)).toBe(143)
      }),
    ),
  )
  scenario(
