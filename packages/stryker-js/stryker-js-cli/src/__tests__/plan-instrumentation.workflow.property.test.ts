...
import {
  ...
  InstrumentError,
  planInstrumentation,
} from '../run/plan-instrumentation.workflow.js'

const InstrumentDecisionTypeId: unique symbol = Symbol.for('@systemfsoftware/stryker-js-cli/run/InstrumentDecision')
