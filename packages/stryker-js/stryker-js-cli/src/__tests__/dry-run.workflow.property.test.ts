...
import { dryRun, DryRunCommand, DryRunError, DryRunFailed, DryRunPassed } from '../run/dry-run.workflow.js'

const DryRunDecisionTypeId: unique symbol = Symbol.for('@systemfsoftware/stryker-js-cli/run/DryRunDecision')
