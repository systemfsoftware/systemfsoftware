...
export class ParseFailed
  extends S.TaggedError<ParseFailed>('@systemfsoftware/stryker-js-cli/instrument/ParseFailed')('ParseFailed', {
    fileName: S.String,
    message: S.String,
...
export class ParserNotFound
  extends S.TaggedError<ParserNotFound>('@systemfsoftware/stryker-js-cli/instrument/ParserNotFound')('ParserNotFound', {
    fileName: S.String,
    extension: S.String,
    cause: S.Defect(),
  })
