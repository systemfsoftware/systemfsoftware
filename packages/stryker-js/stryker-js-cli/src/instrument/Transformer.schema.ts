...
export class PlacementFailed
  extends S.TaggedError<PlacementFailed>('@systemfsoftware/stryker-js-cli/instrument/PlacementFailed')(
    'PlacementFailed',
    {
      fileName: S.String,
      placerName: S.String,
...
export class TransformFailed
  extends S.TaggedError<TransformFailed>('@systemfsoftware/stryker-js-cli/instrument/TransformFailed')(
    'TransformFailed',
    {
      fileName: S.String,
      cause: S.Defect(),
