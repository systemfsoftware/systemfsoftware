...
import type { MutationTestReportReady } from '@systemfsoftware/stryker-js/Reporter'
...
import { HtmlDocument, HtmlReportCommand } from './html-report.schema.js'
...
const writeReportHtmlIfReady = async (
  ...
  if (!S.is(MutationTestReportReadyPayload)(event)) return
