...
import { MutationTestReportReadyPayload } from '../run/abi-payload.schema.js'

import { ConfigError } from '../run/Config.schema.js'
...
export const isTerminalReportEvent = (event: ReporterEvent): boolean => S.is(MutationTestReportReadyPayload)(event)
...
): Effect.Effect<void, never> => offerReporterEvent(stage, { _tag: 'mutationTestReportReady', report, metrics })
