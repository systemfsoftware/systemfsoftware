...
export const loggerShowColors = 'loggerShowColors'
export const loggingSink = 'loggingSink'
export const runEventSink = 'runEventSink'
export const runId = 'runId'
export const resolvedMode = 'resolvedMode'
export const progressEnabled = 'progressEnabled'
export const clearTextEnabled = 'clearTextEnabled'
export const runStartedAt = 'runStartedAt'
export const reporterPluginModules = 'reporterPluginModules'
