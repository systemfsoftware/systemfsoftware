...
| **DC-A2** | The API report carries no `ae-forgotten-export` warnings.                                                                                                                                                                                                                                         | `! grep -q ae-forgotten-export packages/daemon/effect-daemon-conformance/etc/effect-daemon-conformance.api.md` |
