 ...
 * identity) happens in this module's adapter half (`digestFile` below); the
 * kernel receives digested copies and returns the exact serialization
 * upstream's kernel returns for the same inputs.
 */
...
// =============================================================================
// The adapter half — the one I/O edge of reuse identity
// =============================================================================
