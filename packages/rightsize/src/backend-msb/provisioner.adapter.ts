...
import { parseChecksums, type VerifyOutcome, verifyPlan } from './provisioner/checksum.kernel.js'
import { defaultReleaseBase, type EnvResolution, envResolution, resolveCacheDir } from './provisioner/env.kernel.js'
import {
  ...
  isInstalled,
  type RenameStep,
} from './provisioner/install.kernel.js'
import { lockStaleness } from './provisioner/lock.kernel.js'
